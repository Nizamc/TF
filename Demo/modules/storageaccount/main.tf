...
locals {
  ...
  #resource_group_name      = var.create_resource_group ? azurerm_resource_group.new_rg[0].name : var.resource_group_name
...
resource "azurerm_storage_account" "storeacc" {
  ...
  dynamic "identity" {
    ...
    content {
      ...
      identity_ids = var.managed_identity_type == "UserAssigned" || var.managed_identity_type == "SystemAssigned, UserAssigned" ? slice(var.managed_identity_ids, 0, 1) : null
    }
  }
